                                ...
                                <?php 
				                    ...
				                    ?>
                                        <tr>
                                            ...
                                            <td><a href="" bhr class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#inlineForm1<?php echo $d['NIS'];?>">Ubah</a>
                                            <div class="modal fade text-left" id="inlineForm1<?php echo $d['NIS'];?>" tabindex="-1"
                                            role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel33">Ubah siswa </h4>
                                                    ...
                                                    <form action="proses_ubah_siswa.php" method="post">
                                                        ...
                                                        <input type="hidden" name="id" 
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                class="form-control" value="<?=$d['NISN']?>">
                                                            </div>
                                                            <label>NIS </label>
                                                            <div class="form-group">
                                                                <input type="text" name="NIS" placeholder="nama kelas"
                                                                class="form-control" value="<?=$d['NIS']?>">
                                                            </div>
                                                            <label>Nama </label>
                                                            <div class="form-group">
                                                                <input type="text" name="nama" placeholder="nama kelas"
                                                                class="form-control" value="<?=$d['nama']?>">
                                                            </div>
                                                            <label>Alamat </label>
                                                            <div class="form-group">
                                                                <input type="text" name="alamat" placeholder="nama kelas"
                                                                class="form-control" value="<?=$d['alamat']?>">
                                                            </div>
                                                        <label>Kelas</label>
                                                        <div class="form-group">
                                                            <select name="id_kelas" id="id_kelas" class="form-control">
                                                                <option value="<?=$d['id_kelas']?>"></option>
                                                            <?php 
                                                            ...
                                                            <div class="form-group">
                                                                <input  value="<?=$d['no_tlp']?>" type="text" name="no_tlp" placeholder="angkatan"
                                                                class="form-control">
                                                            </div>
                                            ...
                                            <td><a href="hapus_siswa.php?NISN=<?=$d['NISN']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                        <?php
			                            }
