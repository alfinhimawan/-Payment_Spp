            ...
            <div class="page-heading">
                ...
                <section class="section">
                    <div class="card">
                        ...
                        <button type="button" bhr class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#inlineForm">Tambah SPP</button>
                        </div>
                                ...
                                <?php 
				                    ...
				                    ?>
                                        <tr>
                                            ...
                                            <td><a href="" bhr class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#inlineForm1<?php echo $d['id_spp'];?>">Ubah</a>
                                            <div class="modal fade text-left" id="inlineForm1<?php echo $d['id_spp'];?>" tabindex="-1"
                                            role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel33">Ubah SPP </h4>
                                                    ...
                                                    <input type="hidden" name="id_spp" value= "<?=$d['id_spp']?>">
                                                        <div class="modal-body">
                                                            ...
                                                            <label>Tahun</label>
                                                            <div class="form-group">
                                                                <input type="text" name="tahun" placeholder="password"
                                                                class="form-control" value="<?=$d['tahun']?>">
                                                            </div>
                                                            <label>Nominal</label>
                                                            <div class="form-group">
                                                                <input  value="<?=$d['nominal']?>" type="text" name="nominal" placeholder="nominal"
                                                                class="form-control">
                                                            </div>
                                                        </div>
                                            ...
                                            <td><a href="hapus_spp.php?id_spp=<?=$d['id_spp']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                        <?php
			                            }
